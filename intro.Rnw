...
<<>>=
par(mfrow=c(1,2))
s.class(acm$li,as.factor(dt$typo), col=brewer.pal(5,"Set1"), sub="Axes 1 et 2")
s.class(acm$li,as.factor(dt$typo), 3, 4, col=brewer.pal(5,"Set1"), sub="Axes 3 et 4")
par(mfrow=c(1,1))
@
